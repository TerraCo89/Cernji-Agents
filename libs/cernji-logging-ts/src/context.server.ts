/**
 * Server-side correlation ID context management using AsyncLocalStorage
 *
 * This implementation uses Node.js AsyncLocalStorage for proper async context
 * isolation, ensuring correlation IDs are automatically propagated across
 * async boundaries within the same execution context.
 */
