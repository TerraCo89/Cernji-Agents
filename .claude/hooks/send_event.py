...
try:
    ...
    MODEL_EXTRACTOR_AVAILABLE = True
except ImportError:
    MODEL_EXTRACTOR_AVAILABLE = False
...
def main():
    ...
    model_name = ''
    if transcript_path and MODEL_EXTRACTOR_AVAILABLE:
        try:
    ...
    if args.summarize and SUMMARIZER_AVAILABLE:
        try:
